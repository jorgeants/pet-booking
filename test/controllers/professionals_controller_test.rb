...
class ProfessionalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professional" do
    assert_difference('Professional.count') do
      post professionals_url, params: { professional: { cnpj: @professional.cnpj, crmv: @professional.crmv, email: @professional.email, name: @professional.name, telephone: @professional.telephone } }
    end
  ...
  test "should update professional" do
    patch professional_url(@professional), params: { professional: { cnpj: @professional.cnpj, crmv: @professional.crmv, email: @professional.email, name: @professional.name, telephone: @professional.telephone } }
