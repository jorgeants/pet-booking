class ProfessionalsController < ApplicationController
  ...
  def index
    @professionals = Professional.paginate(:page => params[:page], :per_page => 10).order('created_at DESC')
  end
  ...
  private
    ...
    def professional_params
      params.require(:professional).permit(:name, :email, :telephone, :cnpj, :crmv)
    end
end
